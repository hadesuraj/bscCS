...
void findAverageTime(int n, int bt[], int wt[], int tat[]) {
...
void sjfScheduling(int n, int bt[], int at[]) {
...
int main() {
    ...
    // Perform SJF scheduling, print the table, and display results
    sjfScheduling(n, burstTime, arrivalTime);
